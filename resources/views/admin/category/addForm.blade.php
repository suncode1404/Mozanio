...
@section('content')
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.category.list.store') }}" method="POST"   >
            @csrf
            <div class="row">
                <div class="col-md-4">
                    <img src="" alt="Không có hình nào" class="d-block" height="300" id="uploadedAvatar">
                    @error('image')
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3 ">
                        <x-form.text-field name='url_key' type='text' placeholder="Nhập url key"
                            value="{{ old('url_key') }}">
                            Url key<span class="text-danger">*</span></label>
                        </x-form.text-field>
                    </div>
                    <div class="mb-3">
                        <x-form.text-field name='meta_description' type='text' placeholder="Mô tả dài..."
